% This file is based on the multiple shooting example in the CasADi example pack
...
opts = struct('ipopt', ipopt_opts,'jit', true, 'compiler', 'shell', 'jit_options', struct('compiler', 'gcc','flags', ['-O3']) );
