...
python train.py --timesteps 2000000 --env VariableWindLevel0-v17 --psf --psf_T 10  --note "Horizon results "
python train.py --timesteps 2000000 --env VariableWindLevel1-v17 --psf --psf_T 10  --note "Horizon results "
